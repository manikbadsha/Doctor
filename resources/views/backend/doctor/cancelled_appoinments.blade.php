                ...
                <div class="col-lg-12">
                    <div class="card mt-3">
                        <div class="card-header rounded bg-warning text-dark">
                            <b><i class="fas fa-user-clock"></i> Cancelled Appoinments</b>
                        </div>
                        <div class="card-body">
                            <table class="table table-striped">
                                ...
                                @foreach($details as $index=>$item)
                                    ...
                                    @endphp
                                        ...
                                        <td>{{$item->address}}</td>
                                        <td>
                                        <a href="{{url('delete/cancelled/appoinments/by/doctor')}}/{{$item->slug}}" class="btn btn-sm btn-danger rounded">Delete</a>
                                        </td>
                                    </tr>
