                                ...
                                <tbody>
                                    ...
                                    @endphp
                                        ...
                                        <td>
                                            ...
                                            <a href="{{url('delete/recent/approved')}}/{{$item->slug}}" class="btn btn-sm btn-danger rounded">Cancel</a>
                                            <a href="{{url('print/recent/approved')}}/{{$item->slug}}" class="btn btn-sm btn-info rounded"><i class="fas fa-print"></i></a>
                                        </td>
                                    </tr>
